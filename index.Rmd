...
description: |
  This is an introduction to NAPdown.Chapter1 introduces you to the basics of R and RStudio, chapter 2 introduces napdown, a bookdown concept and chapter three on sharing and collaboration with GitHub. The subsequent chapters go into detail about working with different types of data and data sources. 
...
You should have a window like this: ![opening a new .rmd file](tutorial_screenshots/open_rmd_file.png)
