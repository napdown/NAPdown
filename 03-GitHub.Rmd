...
8. Uncheck the box for ‘keep the repository private’ and Click Publish repository
![uncheck private](tutorial_screenshots/gh_desktop_uncheck_private.png)
9. From the menu bar on GitHub desktop, click on `Repository` and select `Push` from the dropdown list.
